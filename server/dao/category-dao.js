...
// Method to read category from a file
...
// Method to write category to a file
...
// Method to remove category from a file
function remove(category) {
  try {
    const filePath = path.join(categoryFolderPath, `${category}.json`);
